...
public class RecyclerAdapter_plan extends RecyclerView.Adapter<RecyclerAdapter_plan.ItemViewHolder> {
    ...
    RecyclerAdapter_plan(Context context, RecyclerView recyclerView_plan){
        //context 설정 (프레그먼트)
    ...
    class ItemViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener  {
        ...
        public void onClick(View v) {
            ...
            {
                Intent intent2 = new Intent(context, PopupActivity_plan.class);

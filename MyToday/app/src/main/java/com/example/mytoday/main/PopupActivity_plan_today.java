...
public class PopupActivity_plan_today extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myPlanNum = PreferenceManager.getInt(getApplicationContext(), "myPlanNum"+userClickDate); //그날 계획의 총개수 (n)
        ...
        btn_delay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //유저가 클릭한 날짜 가져오기
                String planDate ="";
                planDate = PreferenceManager.getString(PopupActivity_plan_today.this, "userClickDate");
                String nextDay = "";
                DateData dateData = new DateData();
                nextDay = dateData.getDate_future_String(planDate,1); //내일날짜

                Integer myPlanNum = null;
                myPlanNum = PreferenceManager.getInt(PopupActivity_plan_today.this, "myPlanNum" + nextDay);
                if (myPlanNum >= 0) {
                    myPlanNum = myPlanNum + 1;
                    PreferenceManager.setInt(PopupActivity_plan_today.this, "myPlanNum" + nextDay,
                            myPlanNum);
                    PreferenceManager.setString(PopupActivity_plan_today.this,
                ...
                Toast.makeText(PopupActivity_plan_today.this, "내일로 미뤘습니다", Toast.LENGTH_SHORT).show();
        ...
        btn_repeat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Integer myDdayNum = PreferenceManager.getInt(PopupActivity_plan_today.this, "myDdayNum"); // 디데이 총개수 (n)

                Log.e("해당 디데이 넘 ", "myDdayNum" + myDdayNum);
                //누른 계획의 내용을 복사
                String targerPlan = PreferenceManager.getString(PopupActivity_plan_today.this, "myPlan"+userClickDate+(m) );
                Log.e("누른 디데이 내용 ", "targerPlan" + targerPlan);
                //

                if (myDdayNum >= 0) {
                    myDdayNum = myDdayNum + 1;
                    PreferenceManager.setInt(PopupActivity_plan_today.this, "myDdayNum",
                            myDdayNum); //총개수 저장
                    PreferenceManager.setString(PopupActivity_plan_today.this,
                            "myDday" + myDdayNum, //"myDdayNum"+총갯수(플랜 번호)
                            targerPlan
                    );
                    ...
                    Log.e("저장한 디데이 내용 ",PreferenceManager.getString(PopupActivity_plan_today.this,
                            "myDday" + myDdayNum //"myDdayNum"+총갯수
                    ));

                    Toast.makeText(PopupActivity_plan_today.this, "디데이로 지정했습니다", Toast.LENGTH_SHORT).show();

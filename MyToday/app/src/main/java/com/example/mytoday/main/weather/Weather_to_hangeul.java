...
public class Weather_to_hangeul {
    Weather_list mCondition;
    ContentValues mData;
    Weather_to_class mWeatherInfo;

    public Weather_to_hangeul(Weather_to_class tData)
    {
        mCondition = new Weather_list();
        mWeatherInfo = tData;
...
//        mWeatherInfo.setWind_Name(Hangeul_Weather(mWeatherInfo.wind_Name));
    ...
    public Weather_to_class getHangeulWeather()
    {
        return mWeatherInfo;
    }
